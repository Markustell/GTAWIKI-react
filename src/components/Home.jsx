...
function Home() {
  return (
    <>
        <div className="flex flex-col justify-center items-center bg-[url('/src/images/background/cover.png')] bg-cover bg-center bg-no-repeat py-[2rem] animate-[zoomloop_10s_ease-in-out_infinite] sm:animate-[zoomloopSm_10s_ease-in-out_infinite]  md:animate-[zoomloopMd_15s_ease-in-out_infinite] lg:animate-[zoomloopLg_15s_ease-in-out_infinite]">
