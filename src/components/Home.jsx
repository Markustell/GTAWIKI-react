...
function Home() {
  return (
    <>
        <div className="flex flex-col justify-center items-center bg-[url('/src/images/background/cover.png')] bg-cover py-[2rem]">
            <img src="/src/images/logo/gta_logo.png" alt="Grand Theft Auto Logo" className='h-1/2 w-1/2 md:h-1/3 md:w-1/3 lg:h-1/4 lg:w-1/4'/>
