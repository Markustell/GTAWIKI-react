      ...
      <header className='flex justify-center h-[80px] w-[100%]'>
        <nav className='flex justify-between items-center w-[90%]'>
          <div className="flex h-full w-1/2 items-center">
            <Link to='/'>
              <img src="/src/images/logo/short_logo.png" alt="GTAWIKI" className='lg:hidden h-[60px] ease-out duration-300 hover:scale-[0.95]' />
          ...
          <div className="flex items-center justify-end h-full w-1/2 ">
            <form action="" className='w-full lg:w-5/6'>
              ...
              <input type="text" className='w-full h-[35px] pl-9 rounded-full focus:outline-none ease-in-out duration-150 focus:shadow-[5px_5px_0_#ff0f38]' />
            </form>
          </div>
        </nav>
      </header>
